...
Gossip.destroy_all
City.where.not(id: 100).destroy_all
Tag.destroy_all
...
20.times do
    ...
    gossip = Gossip.create!(title: title, description: description, user: users.sample)
    gossips << gossip
end
...
tags = []
10.times do
    tag = Tag.create!(name: Faker::Lorem.words(number: 1))
    tags << tag
end
